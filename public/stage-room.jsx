    ...
    <div className="stage-room" data-screen-label="Stage room">
      ...
      <div className="stage-nav">
        ...
        <div className="stage-nav-tabs">
          {['Stage', 'Rooms', 'Agenda', 'Sponsors'].map((t) => {
            const activeTab = modal === 'rooms' ? 'Rooms' : modal === 'agenda' ? 'Agenda' : modal === 'sponsors' ? 'Sponsors' : 'Stage';
            return (
              <button key={t} className={`stage-nav-tab ${activeTab === t ? 'active' : ''}`}
                onClick={() => { if (t === 'Stage') setModal(null); else if (t === 'Rooms') setModal('rooms'); else if (t === 'Agenda') setModal('agenda'); else if (t === 'Sponsors') setModal('sponsors'); }}>{t}</button>
            );
          })}
        </div>
